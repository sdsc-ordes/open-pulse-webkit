...
Design systems are delivered to agents **as skills** — a brand lives in `.claude/skills/<name>/` as a `SKILL.md` plus token/reference files, and swapping brands means swapping the skill, not rewriting app code (see `.claude/SKILLS.md` §11 for how to integrate your own).
