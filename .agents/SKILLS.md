...
The worked example is [sdsc-ordes/open-pulse-enac](https://github.com/sdsc-ordes/open-pulse-enac) — a landing page + four question-anchored themes + a coverage panel. When asked for "a dashboard", default to this shape (see `AGENTS.md` → *Reference outcome*). Rules that came out of building it:
